    ...
    if (!subgroup) {
      if (sub == "profile") {
        ...
        if (platform == "al") {
          ...
          const alprofile = new EmbedBuilder()
            ...
            .setFooter({ text: "Data sent from AniList", iconURL: ctx.user.dynamicAvatarURL("png") })
            .setTimestamp();
        ...
        if (type == "anime") {
          ...
          const animeEmbed = new EmbedBuilder()
            ...
            .setFooter({ text: 'Powered by kitsu.io', iconURL: ctx.user.dynamicAvatarURL("png") })
            .setTimestamp();
          // send it
          ...
          const embed = new EmbedBuilder()
            ...
            .setColor(util.color)
            .setTimestamp()
            .setFooter({ text: `Data sent from AniList • ${res.favourites} people love ${res.name.full}`, iconURL: ctx.user.dynamicAvatarURL("png") });
      ...
      if (sub == "list") {
        ...
        const embed = new EmbedBuilder()
          ...
          .setFooter({
            text: `Requested by ${ctx.user.username}`, iconURL: ctx.user.dynamicAvatarURL("png")
          }).setTimestamp()
          .addFields({
            name: 'Tips', value: `${[
