    ...
    if (sub == "ping") {
      ...
      if (sub == "terms") {
        ...
        const termsEmbed = new EmbedBuilder()
          ...
          .setFooter({ text: "Last edited 15/8/2022", iconURL: ctx.user.dynamicAvatarURL("png") })
          .setTimestamp()
        ...
        const infoCard = new EmbedBuilder()
          ...
          .setFooter({ text: "Please read this carefully.", iconURL: ctx.user.dynamicAvatarURL("png") })
          .setTimestamp()
          .setDescription(
