// direct port from npm/html-to-markdown to simplify installations
// thank you!
...
var formatters = [replaceHeading, replaceParagraph, replacePre, replaceUl, replaceOl, replaceBold, replaceItalic, replaceBlockQuote];
