...
export default class NekoClient extends SlashCreator {
  ...
  // we're kinda "extending" the default fetch handler
  // as we need support for the html page and database connection
  async fetch(request, env, ctx) {
    ...
    for (const settingsArr of Object.entries(this.settings)) { await settingsArr[1].init() };
